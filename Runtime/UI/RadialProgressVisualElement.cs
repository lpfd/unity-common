...
namespace Leap.Forward.UI
{
    ...
    /// </summary>
    [UxmlElement]
    public partial class RadialProgressVisualElement : VisualElement
    {
        ...
        public RadialProgressVisualElement()
        {
        ...
        {
            RadialProgressVisualElement element = (RadialProgressVisualElement)evt.currentTarget;
        ...
        {
            RadialProgressVisualElement element = (RadialProgressVisualElement)context.visualElement;
